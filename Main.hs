...
main = do 
	...
	putStrLn ("Test 4: " ++ normPolyTest [(12, [('x', 1)]), (-4, [('y', 1)])] [(-4, [('y', 1)]), (12, [('x', 1)])])
	putStrLn ("Test 5: " ++ normPolyTest [(-12, [('x', 1)]), (4, [('x', 1)])] [(-8, [('x', 1)])])
	putStrLn ("Test 6: " ++ normPolyTest [(-12, [('x', 1), ('y', 3)]), (4, [('y', 3), ('x', 1)]), (-5, [])] [(-8, [('x', 1), ('y', 3)]), (-5,[])]) 
	putStrLn ("Test 7: " ++ normPolyTest [(1, [('x', 2)]), (-1, [('x', 2)])] [(0, [])])
	putStrLn ("Test 8: " ++ normPolyTest [(4,[('x',2), ('y', 3)]), (3,[('x',1)]), (1, [('y', 3), ('x',2)]), (1,[('y',1)]), (0,[('z',1)])] [(1,[('y',1)]),(5,[('x',2),('y',3)]), (3,[('x',1)])])
	...
	putStrLn ("Test 4: " ++ addPolyTest [(5,[('x', 1)])] [(-4,[('y', 1)])] [(-4, [('y', 1)]), (5, [('x', 1)])])
	putStrLn ("Test 5: " ++ addPolyTest [(-3,[('x', 2), ('y',1)])] [(9,[('x', 1), ('y',1)])] [(-3,[('x',2), ('y', 1)]), (9,[('x', 1), ('y', 1)])])
	putStrLn ("Test 6: " ++ addPolyTest [(-3,[('x', 2), ('y',1)])] [(9,[('y',1),('x',2)])] [(6, [('x', 2), ('y', 1)])])
	putStrLn ("Test 7: " ++ addPolyTest [(-3,[('x', 2), ('y',1)]), (1,[])] [(9,[('x', 1), ('y',1)]), (2,[])] [(-3,[('x',2), ('y', 1)]), (9,[('x', 1), ('y', 1)]), (3,[])])
	...
	putStrLn ("Test 3: " ++ derivePolyTest [(1, [('x', 2)]), (-3, [('x', 1)]), (10, [('x', 10)])] [(100, [('x', 9)]), (2, [('x', 1)]), (-3, [])] 'x')
	...
	putStrLn ("Test 5: " ++ multPolyTest [(7, [('x', 3), ('y', 1)]), (13, [('z',1)])] [(4, [('x', 1), ('z', 3)]),(-1, [('y', 3)])] [(-13,[('y',3),('z',1)]), (28,[('x',4),('y',1),('z', 3)]),(-7,[('x',3),('y',4)]), (52,[('x',1),('z',4)])])
	...
	putStrLn ("Test 5: " ++ polyToStrTest [(9, [('x', 3)])] "9x^3")
